...
public class CreateActivityController : Controller
{
    ...
    public IActionResult CreateActivity(List<IFormFile> Img)
    {
        ...
        foreach (var (key, value) in notFormatFormData){
        ...
        Console.WriteLine(notFormatFormData["Tag"]);
        ...
        DateTime RecruitEnd = DateTime.Parse(notFormatFormData["Date"]).AddDays(-1);
        formData["RecruitEnd"] = RecruitEnd.ToString("dd/MM/yyyy");
